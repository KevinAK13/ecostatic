...
import cesp1 from 'assets/img/Caballos/cesp1.JPG';
import cesp2 from 'assets/img/Caballos/cesp2.JPG';
        ...
        <div className="lg:col-span-1">
          <div className="rounded bg-gray-100 p-6 sm:p-8">
            <div className="mx-auto max-w-md text-center lg:text-left">
              <header>
                <h2 className="text-2xl font-bold text-gray-900 sm:text-4xl">Raza Españoles</h2>
