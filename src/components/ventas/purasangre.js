...
import cps1 from 'assets/img/Caballos/cps1.JPG';
import cps2 from 'assets/img/Caballos/cps2.JPG';
        ...
        <div className="lg:col-span-1">
          <div className="rounded bg-gray-100 p-6 sm:p-8">
            <div className="mx-auto max-w-md text-center lg:text-left">
              <header>
                <h2 className="text-2xl font-bold text-gray-900 sm:text-4xl">Raza Pura Sangre</h2>
