import Appaloosa from "components/ventas/appaloosa"
import Azteca from "components/ventas/azteca"
import Cuartodemilla from "components/ventas/cuartodemilla"
import Españoles from "components/ventas/españoles"
import Header from "components/ventas/header"
import Purasangre from "components/ventas/purasangre"
...
function CVenta()
{
    ...
    return(
        <Layout>
      <Helmet>
        <title>Rancho Tepic | Caballos en venta</title>
